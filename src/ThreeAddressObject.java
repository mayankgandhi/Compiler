...
public class ThreeAddressObject { // Three Address Object
	enum Operation{
		NUM, PLUS, MINUS, MUL, DIV, LT, LTE, GT, GTE, LEFTPAREN, RIGHTPAREN, EQUALS, NOTEQUALS, ASSIGN, ID, INT, SEMICOLON, LEFTCURLY, RIGHTCURLY, IF, 
		WHILE, START_WHILE, AND, OR, VOID, PUBLIC, PRIVATE, CLASS, PROGRAM, INVALID, LABEL, GOTO, EQ, NOEQ, EQEQ;
	}
	...
	ThreeAddressObject(ThreeAddressObject aTao){
		op = aTao.op;
		src1 = aTao.src1;
		src2 = aTao.src2;
